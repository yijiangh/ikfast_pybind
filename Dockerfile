...
RUN apt-get -y update && \
  apt install -y wget ros-kinetic-collada-urdf ros-kinetic-rosbash
...
RUN wget https://raw.githubusercontent.com/ros-planning/moveit/kinetic-devel/moveit_kinematics/ikfast_kinematics_plugin/scripts/round_collada_numbers.py
