...
PYBIND11_MODULE(ikfast_p_rob3, m)
{
    m.doc() = R"pbdoc(
        ikfast_pybind_p_rob3
        -----------------------
        .. currentmodule:: ikfast_pybind_p_rob3
        .. autosummary::
           :toctree: _generate
           get_ik
           get_fk
    ...
    py::arg("rot_list"),
    R"pbdoc(
        get inverse kinematic solutions for pybind_p_rob3
    )pbdoc");
