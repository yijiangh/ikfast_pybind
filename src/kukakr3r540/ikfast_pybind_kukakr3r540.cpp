...
PYBIND11_MODULE(ikfast_kukakr3r540, m)
{
    m.doc() = R"pbdoc(
        ikfast_pybind_kukakr3r540
        -----------------------
        .. currentmodule:: ikfast_pybind_kukakr3r540
        .. autosummary::
           :toctree: _generate
           get_ik
           get_fk
    ...
    py::arg("rot_list"),
    R"pbdoc(
        get inverse kinematic solutions for pybind_kukakr3r540
    )pbdoc");
