...
#include <kukakr10r1100sixx/ikfast.h>
...
PYBIND11_MODULE(ikfast_kukakr10r1100sixx, m)
{
    m.doc() = R"pbdoc(
        ikfast_pybind_kukakr10r1100sixx
        -----------------------
        .. currentmodule:: ikfast_pybind_kukakr10r1100sixx
        .. autosummary::
           :toctree: _generate
           get_ik
           get_fk
    ...
    py::arg("rot_list"),
    R"pbdoc(
        get inverse kinematic solutions for pybind_kukakr10r1100sixx
    )pbdoc");
