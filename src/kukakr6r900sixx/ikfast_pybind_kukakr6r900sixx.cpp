...
#include <kukakr6r900sixx/ikfast.h>
...
PYBIND11_MODULE(ikfast_kukakr6r900sixx, m)
{
    m.doc() = R"pbdoc(
        ikfast_pybind_kukakr6r900sixx
        -----------------------
        .. currentmodule:: ikfast_pybind_kukakr6r900sixx
        .. autosummary::
           :toctree: _generate
           get_ik
           get_fk
    ...
    py::arg("rot_list"),
    R"pbdoc(
        get inverse kinematic solutions for pybind_kukakr6r900sixx
    )pbdoc");
